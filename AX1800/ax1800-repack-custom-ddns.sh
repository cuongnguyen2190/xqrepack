#!/usr/bin/env bash
#
# unpack, modify and re-pack the Xiaomi R1800 firmware
...
command -v unsquashfs || { echo "install unsquashfs"; exit 1; }
mksquashfs -version || { echo "install mksquashfs"; exit 1; }
...
boot_hook_add preinit_main enable__access
NVRAM
